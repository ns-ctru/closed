...
```{r emergency_admissions_any, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = TRUE}
emergency.admissions.any <- closed_models(df.lsoa         = emergency_admissions_measure,
