...
3.2    | Individual and All | All Matched (Pooled)      | ED  | season + time + closure * pooled.site + nhs111 + other.centre + ambulance.diversion
4      | All (Pooled) | One Matched      | ED    | season + time + closure * site + nhs111 + other.centre + ambulance.diversion
5      | All (Pooled) | One Matched      | ED    | season + time + closure * site + nhs111 + other.centre + ambulance.diversion
6.1      | Individual   | None           | LSOA  | season + time + closure * site + nhs111 + other.centre + ambulance.diversion + change in ED time
6.2      | All (Pooled) | One Matched      | LSOA  | season + time + closure * site + nhs111 + other.centre + ambulance.diversion + change in ED time
