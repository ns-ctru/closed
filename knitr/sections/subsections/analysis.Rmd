...
```
```{r summary_analysis, echo = FALSE, cache = FALSE, results = 'asis', eval = TRUE}
...
```{r unnecessary_ed_attendances, echo = FALSE, cache = FALSE, results = 'hide', eval = TRUE}
...
<!--- Critical Care - All --->
```{r critical_care_cips_all, echo = FALSE, cache = FALSE, results = 'hide', eval = TRUE}
...
```{r critical_care_cips_critical, echo = FALSE, cache = FALSE, results = 'hide', eval = TRUE}
...
```{r critical_care_cips_fraction, echo = FALSE, cache = FALSE, results = 'hide', eval = TRUE}
...
<!--- Length of Stay - Mean --->
```{r length_of_stay_mean, echo = FALSE, cache = FALSE, results = 'hide', eval = TRUE}
...
```{r length_of_stay_median, echo = FALSE, cache = FALSE, results = 'hide', eval = TRUE}
