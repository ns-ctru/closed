...
##    load('d:/Rpackages/rclosed/data/critical care stays measure - site - 2016-05-24 14.32.Rda')
    ...
    ## load('~/work/scharr/closed/lib/data/ambulance non-conveyance measure - lsoa - 2016-08-01 17.16.Rda')
    ## load('~/work/scharr/closed/lib/data/ambulance non-conveyance measure - site - 2016-08-01 17.16.Rda')
    ## load('~/work/scharr/closed/lib/data/ambulance non-conveyance measure - lsoa - 2016-07-15 20.09.Rda')
    ## load('~/work/scharr/closed/lib/data/ambulance non-conveyance measure - site - 2016-07-15 20.09.Rda')
    ...
    load('~/work/scharr/closed/lib/data/case fatality measure - lsoa - 2016-11-24 18.46.Rda')
    load('~/work/scharr/closed/lib/data/case fatality measure - site - 2016-11-24 18.46.Rda')
...
amb_red_calls_site_measure_clean <- closed_clean(df      = amb_red_calls_site_measure,
                                                ...
                                                systematic    = systematic.outlier,
                                                balance       = FALSE)
hospital_transfers_site_measure_clean <- closed_clean(df = hospital_transfers_site_measure,
...
amb_red_calls_site_measure_clean_sd2 <- closed_clean(df      = amb_red_calls_site_measure,
                                                ...
                                                systematic    = systematic.outlier,
                                                balance       = FALSE)
hospital_transfers_site_measure_clean_sd2 <- closed_clean(df      = hospital_transfers_site_measure,
                                                indicator     = 'hospital transfers',
                                                sub.indicator = 'stays with transfer',
                                                systematic    = systematic.outlier,
                                                balance       = FALSE)
...
hospital.transfers.all.stays <- closed_models(df.lsoa         = hospital_transfers_measure,
...
hospital.transfers.stays.with.transfer <- closed_models(df.lsoa         = hospital_transfers_measure,
                                     df.trust         = hospital_transfers_site_measure_clean,
                                     indicator        = 'hospital transfers',
                                     sub.indicator    = 'stays with transfer',
                                     steps            = c('closure'),
