...
if(os != 'unix' | node != 'mcru-closed-hp.shef.ac.uk'){
    ...
    model.opts$mod7.1 <- c('town * closure', 'season', 'relative.month', 'nhs111', 'other.centre', 'ambulance.divert', 'diff.time.to.ed')
    model.opts$mod7.2 <- c('town * closure', 'season', 'relative.month', 'nhs111', 'other.centre', 'ambulance.divert', 'diff.time.to.ed')}
...
if(negbin.for.counts == TRUE){
    mode.of.arrival.any <- closed_tsglm(df.lsoa          = ed_attendances_by_mode_measure,
...
if(negbin.for.counts == TRUE){
    mode.of.arrival.other <- closed_tsglm(df.lsoa          = ed_attendances_by_mode_measure,
                                     df.trust         = ed_attendances_by_mode_site_measure_clean,
                                     indicator        = 'ed attendances',
                                     sub.indicator    = 'other',
                                     panel.lsoa       = model.opts$panel.lsoa,
...
if(negbin.for.counts == TRUE){
    mode.of.arrival.ambulance <- closed_tsglm(df.lsoa          = ed_attendances_by_mode_measure,
                                     df.trust         = ed_attendances_by_mode_site_measure_clean,
                                     indicator        = 'ed attendances',
...
if(negbin.for.counts == TRUE){
    unnecessary.attendance <- closed_tsglm(df.lsoa         = unnecessary_ed_attendances_measure,
...
if(negbin.for.counts == TRUE){
    all.emergency.admissions.all <- closed_tsglm(df.lsoa         = emergency_admissions_measure,
...
if(negbin.for.counts == TRUE){
    avoidable.emergency.admissions.any <- closed_tsglm(df.lsoa         = emergency_admissions_measure,
                                     df.trust         = emergency_admissions_site_measure_clean,
                                     indicator        = 'avoidable emergency admissions',
                                     sub.indicator    = 'any',
                                     panel.lsoa       = model.opts$panel.lsoa,
...
if(negbin.for.counts == TRUE){
    avoidable.emergency.admissions.chest.pain <- closed_tsglm(df.lsoa         = emergency_admissions_measure,
                                     df.trust         = emergency_admissions_site_measure_clean,
                                     indicator        = 'avoidable emergency admissions',
...
if(negbin.for.counts == TRUE){
    ed.attendances.admitted.all <- closed_tsglm(df.lsoa         = ed_attendances_admitted_measure,
...
if(negbin.for.counts == TRUE){
    ed.attendances.admitted.admitted <- closed_tsglm(df.lsoa         = ed_attendances_admitted_measure,
                                     df.trust         = ed_attendances_admitted_site_measure_clean,
                                     indicator        = 'ed attendances admitted',
...
if(negbin.for.counts == TRUE){
    critical.care.cips.all <- closed_tsglm(df.lsoa         = critical_care_cips_measure,
...
if(negbin.for.counts == TRUE){
    critical.care.cips.critical <- closed_tsglm(df.lsoa         = critical_care_cips_measure,
                                     df.trust         = critical_care_cips_site_measure_clean,
                                     indicator        = 'critical care stays',
...
if(negbin.for.counts == TRUE){
    ambulance.non.conveyances.green.calls <- closed_tsglm(df.lsoa         = amb_green_calls_measure,
    ...
    ambulance.non.conveyances.green.calls <- closed_models(df.lsoa         = amb_green_calls_measure,
                                     df.trust         = amb_green_calls_site_measure_clean,
                                     indicator        = 'ambulance green calls',
                                     sub.indicator    = 'green calls',
                                     panel.lsoa       = model.opts$panel.lsoa,
...
if(negbin.for.counts == TRUE){
    ambulance.non.conveyances.green.calls.non.conveyed <- closed_tsglm(df.lsoa         = amb_green_calls_measure,
                                     df.trust         = amb_green_calls_site_measure_clean,
                                     indicator        = 'ambulance green calls',
    ...
    ambulance.non.conveyances.green.calls.non.conveyed <- closed_models(df.lsoa         = amb_green_calls_measure,
                                     df.trust         = amb_green_calls_site_measure_clean,
                                     indicator        = 'ambulance green calls',
                                     sub.indicator    = 'not conveyed green calls',
                                     panel.lsoa       = model.opts$panel.lsoa,
...
if(negbin.for.counts == TRUE){
    ambulance.red.calls.hospital.transfers <- closed_tsglm(df.lsoa         = amb_red_calls_measure,
...
if(negbin.for.counts == TRUE){
    ambulance.red.calls.total <- closed_tsglm(df.lsoa         = amb_red_calls_measure,
                                     df.trust         = amb_red_calls_site_measure_clean,
                                     indicator        = 'ambulance red calls',
                                     sub.indicator    = 'total',
                                     panel.lsoa       = model.opts$panel.lsoa,
...
if(negbin.for.counts == TRUE){
    hospital.transfers.all.stays <- closed_tsglm(df.lsoa         = hospital_transfers_measure,
...
if(negbin.for.counts == TRUE){
    hospital.transfers.stays.with.transfer <- closed_tsglm(df.lsoa         = hospital_transfers_measure,
                                     df.trust         = hospital_transfers_site_measure_clean,
                                     indicator        = 'hospital transfers',
                                     sub.indicator    = 'stays with transfer',
                                     panel.lsoa       = model.opts$panel.lsoa,
