...
## Convert everything to data frames, why I didn't do this first I've no idea!
...
unnecessary_ed_attendances_measure      <- as.data.frame(unnecessary_ed_attendances_measure)
unnecessary_ed_attendances_site_measure <- as.data.frame(unnecessary_ed_attendances_site_measure)
ed_attendances_admitted_measure         <- as.data.frame(ed_attendances_admitted_measure)
ed_attendances_admitted_site_measure    <- as.data.frame(ed_attendances_admitted_site_measure)
critical_care_cips_measure              <- as.data.frame(critical_care_cips_measure)
critical_care_cips_site_measure         <- as.data.frame(critical_care_cips_site_measure)
emergency_admissions_measure            <- as.data.frame(emergency_admissions_measure)
emergency_admissions_site_measure       <- as.data.frame(emergency_admissions_site_measure)
length_of_stay_measure                  <- as.data.frame(length_of_stay_measure)
length_of_stay_site_measure             <- as.data.frame(length_of_stay_site_measure)
...
## And convert all variable names to periods not underscore
names(ed_attendances_by_mode_measure)          <- gsub('_', '.', names(ed_attendances_by_mode_measure))
names(ed_attendances_by_mode_site_measure)     <- gsub('_', '.', names(ed_attendances_by_mode_site_measure))
names(unnecessary_ed_attendances_measure)      <- gsub('_', '.', names(unnecessary_ed_attendances_measure))
names(unnecessary_ed_attendances_site_measure) <- gsub('_', '.', names(unnecessary_ed_attendances_site_measure))
names(ed_attendances_admitted_measure)         <- gsub('_', '.', names(ed_attendances_admitted_measure))
names(ed_attendances_admitted_site_measure)    <- gsub('_', '.', names(ed_attendances_admitted_site_measure))
names(critical_care_cips_measure)              <- gsub('_', '.', names(critical_care_cips_measure))
names(critical_care_cips_site_measure)         <- gsub('_', '.', names(critical_care_cips_site_measure))
names(emergency_admissions_measure)            <- gsub('_', '.', names(emergency_admissions_measure))
names(emergency_admissions_site_measure)       <- gsub('_', '.', names(emergency_admissions_site_measure))
names(length_of_stay_measure)                  <- gsub('_', '.', names(length_of_stay_measure))
names(length_of_stay_site_measure)             <- gsub('_', '.', names(length_of_stay_site_measure))
...
unnecessary_ed_attendances_measure$sub.measure <- ifelse(is.na(unnecessary_ed_attendances_measure$sub.measure),
                                                         'all',
                                                         unnecessary_ed_attendances_measure$sub.measure)
unnecessary_ed_attendances_site_measure$sub.measure <- ifelse(is.na(unnecessary_ed_attendances_site_measure$sub.measure),
                                                         'all',
                                                         unnecessary_ed_attendances_site_measure$sub.measure)
emergency_admissions_measure$sub.measure <- ifelse(is.na(emergency_admissions_measure$sub.measure),
                                                   'all',
                                                   emergency_admissions_measure$sub.measure)
emergency_admissions_site_measure$sub.measure <- ifelse(is.na(emergency_admissions_site_measure$sub.measure),
                                                        'all',
                                                        emergency_admissions_site_measure$sub.measure)
## Convert time from seconds to minutes and ensure they're numeric.
amb_mean_times_measure$value <- amb_mean_times_measure$value / 60 %>% as.numeric
amb_mean_times_site_measure$value <- amb_mean_times_site_measure$value / 60 %>% as.numeric
