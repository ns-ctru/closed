...
```
```{r define_models, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
```
```{r summary_analysis, echo = FALSE, cache = TRUE, results = 'asis', eval = TRUE}
...
```
<!--- Mode of Arrival - Any --->
```{r mode_of_arrival_any, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
```{r mode_of_arrival_other, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
```{r mode_of_arrival_ambulance, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
```{r unnecessary_ed_attendances, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
```{r ed_attendances_admitted_all, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
```{r ed_attendances_admitted_fraction_admitted, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
```{r ed_attendances_admitted_admitted, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
<!--- Critical Care - All --->
```{r critical_care_cips_all, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
```{r critical_care_cips_critical, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
```{r critical_care_cips_fraction, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
<!--- Length of Stay - Mean --->
```{r length_of_stay_mean, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
...
```{r length_of_stay_median, echo = FALSE, cache = TRUE, results = 'hide', eval = TRUE}
