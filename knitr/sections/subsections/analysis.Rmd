...
model.opts$mod3.1  <- c('pooled.control * closure', 'town', 'season', 'relative.month', 'nhs111', 'other.centre', 'ambulance.divert')
model.opts$mod3.2  <- c('pooled.control * closure', 'town', 'season', 'relative.month', 'nhs111', 'other.centre', 'ambulance.divert')model.opts$mod4   <- c('town * closure', 'season', 'relative.month', 'nhs111', 'other.centre', 'ambulance.divert')
...
model.opheck.ed.admitted    <- closed_missing_summary(df.lsoa = ed_attendances_admitted_measure,
