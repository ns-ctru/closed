...
case.fatality.ratio.any <- closed_models(df.lsoa         = case_fatality_ratio_measure,
                                     df.trust         = case_fatality_ratio_site_measure,
...
case.fatality.ratio.acute.heart.failure <- closed_models(df.lsoa         = case_fatality_ratio_measure,
                                     df.trust         = case_fatality_ratio_site_measure,
                                     indicator        = 'case fatality ratio',
...
ambulance.mean.times.call.to.destination <- closed_models(df.lsoa         = ambulance_mean_times_measure,
                                     df.trust         = ambulance_mean_times_site_measure,
