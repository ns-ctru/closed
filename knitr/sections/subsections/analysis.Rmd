...
model.opts$mod6.2  <- c('town', 'season', 'relative.month', 'nhs111', 'other.centre', 'ambulance.divert', 'diff.time.to.ed')
if(os != 'unix' | node != 'mcru-closed-hp.shef.ac.uk'){
    model.opts$mod7.1 = NULL
    model.opts$mod7.2 = NULL
} else{
    model.opts$mod7.1 <- c('season', 'relative.month', 'nhs111', 'other.centre', 'ambulance.divert', 'diff.time.to.ed')
    model.opts$mod7.2 <- c('town', 'season', 'relative.month', 'nhs111', 'other.centre', 'ambulance.divert', 'diff.time.to.ed')}
