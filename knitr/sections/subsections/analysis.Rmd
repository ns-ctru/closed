...
if(negbin.for.counts == TRUE){
    ambulance.non.conveyances.green.calls <- closed_tsglm(df.lsoa         = amb_non_conveyance_measure,
...
if(negbin.for.counts == TRUE){
    ambulance.non.conveyances.green.calls.non.conveyed <- closed_tsglm(df.lsoa         = amb_non_conveyance_measure,
                                     df.trust         = amb_non_conveyance_site_measure_clean,
                                     indicator        = 'ambulance non-conveyance',
