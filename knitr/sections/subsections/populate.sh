...
sed -e 's/template/ambulance.mean.times.call.to.dest/g' \
    ...
    -e "s/model3_1, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE/model3_1, echo = FALSE, cache = FALSE, results = 'markup', eval = FALSE/g" \
    -e "s/model3_2, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE/model3_2, echo = FALSE, cache = FALSE, results = 'markup', eval = FALSE/g" \
    -e "s/model5, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE/model5, echo = FALSE, cache = FALSE, results = 'markup', eval = FALSE/g" \
...
sed -e 's/template/ambulance.mean.times.scene.to.dest/g' \
    ...
    -e "s/model3_2, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE/model3_2, echo = FALSE, cache = FALSE, results = 'markup', eval = FALSE/g" \
    -e "s/model5, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE/model5, echo = FALSE, cache = FALSE, results = 'markup', eval = FALSE/g" \
    -e "s/model6_1, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE/model6_1, echo = FALSE, cache = FALSE, results = 'markup', eval = FALSE/g" \
    -e "s/model6_2, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE/model6_2, echo = FALSE, cache = FALSE, results = 'markup', eval = FALSE/g" \
    -e "s/model7, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE/model7, echo = FALSE, cache = FALSE, results = 'markup', eval = FALSE/g" \
...
sed -e 's/template/hospital.transfers.all.stays/g' \
    -e 's/data_frame/hospital_transfers_measure/g' \
    -e 's/Measure/hospital transfers/g' \
    -e 's/sub_measure/all stays/g' \
    -e 's/DESCRIPTION/Hospital Transfers - All Stays/g' \
...
sed -e 's/template/hospital.transfers.stays.with.transfer/g' \
    ...
    -e 's/DESCRIPTION/Hospital Transfers - Stays With Transfer/g' \
    template.Rmd > hospital_transfers_stays_with_transfer.Rmd
...
sed -e 's/template/hospital.transfers.proportion.with.transfer/g' \
    ...
    -e 's/DESCRIPTION/Hospital Transfers - Proportion With Transfer/g' \
    template.Rmd > hospital_transfers_proportion_with_transfer.Rmd
