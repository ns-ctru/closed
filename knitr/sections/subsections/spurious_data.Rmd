...
emergency.admissions.clean.unbalanced <- filter(emergency.admissions.clean.unbalanced,
...
## case.fatality.clean.unbalanced <- filter(case.fatality.clean.unbalanced,
...
spurious <- rbind(ed.attendances.clean.unbalanced,
...
amb.mean.times.clean.unbalanced <- closed_clean(df      = t,
                                                ...
                                                balance       = FALSE)
## Combine all cleaned (and now missing) data points into one data frame
spurious2 <- rbind(ed.attendances.clean.unbalanced,
                  unnecessary.attendances.clean.unbalanced,
                  emergency.admissions.clean.unbalanced,
                  ed.attendances.admitted.clean.unbalanced,
                  critical.care.clean.unbalanced,
