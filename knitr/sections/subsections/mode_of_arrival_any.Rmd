...
```{r mode_of_arrival_any_model3a, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
mode.of.arrival.any$model3a.ts.plot
mode.of.arrival.any$model3a.forest$forest
mode.of.arrival.any$model3a.panelar.all$coef[3:8] %>% kable(caption = mode.of.arrival.any$model3a.panelar.all$caption)
```
...
```{r mode_of_arrival_any_model3b, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
mode.of.arrival.any$model3b.ts.plot
mode.of.arrival.any$model3b.forest$forest
mode.of.arrival.any$model3b.panelar.all$coef[3:8] %>% kable(caption = mode.of.arrival.any$model3b.panelar.all$caption)
```
