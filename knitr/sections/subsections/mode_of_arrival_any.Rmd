...
closed_ts_plot(df            = ed_attendances_by_mode_site_measure,
               ...
               legend        = TRUE)
kable(mode.of.arrival.any$summary.table.bishop,
...
closed_ts_plot(df            = ed_attendances_by_mode_site_measure,
               ...
               legend        = TRUE)
kable(mode.of.arrival.any$summary.table.hartlepool,
      align   = summary.table.align,
...
closed_ts_plot(df            = ed_attendances_by_mode_site_measure,
               ...
               legend        = TRUE)
kable(mode.of.arrival.any$summary.table.hemel,
      align   = summary.table.align,
...
closed_ts_plot(df            = ed_attendances_by_mode_site_measure,
               ...
               legend        = TRUE)
kable(mode.of.arrival.any$summary.table.newark,
      align   = summary.table.align,
...
closed_ts_plot(df            = ed_attendances_by_mode_site_measure,
               ...
               legend        = TRUE)
kable(mode.of.arrival.any$summary.table.rochdale,
      align   = summary.table.align,
...
mode.of.arrival.any$model1.panelar.all$coef[3:8] %>% kable(caption = mode.of.arrival.any$model1.panelar.all$caption)
```
...
mode.of.arrival.any$model2.panelar.all$coef[3:8] %>% kable(caption = mode.of.arrival.any$model2.panelar.all$caption)
```
...
```{r mode_of_arrival_any_model3_1, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
mode.of.arrival.any$model3.1.ts.plot
mode.of.arrival.any$model3.1.forest$forest
mode.of.arrival.any$model3.1.panelar.all$coef[3:8] %>% kable(caption = mode.of.arrival.any$model3.1.panelar.all$caption)
```
...
```{r mode_of_arrival_any_model3_2, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
mode.of.arrival.any$model3.2.ts.plot
mode.of.arrival.any$model3.2.forest$forest
mode.of.arrival.any$model3.2.panelar.all$coef[3:8] %>% kable(caption = mode.of.arrival.any$model3.2.panelar.all$caption)
```
...
mode.of.arrival.any$model4.panelar.all$coef[3:9] %>% kable(caption = mode.of.arrival.any$model4.panelar.all$caption)
```
...
mode.of.arrival.any$model5.panelar.all$coef[3:9] %>% kable(caption = mode.of.arrival.any$model5.panelar.all$caption)
```
...
```{r mode_of_arrival_any_model6_1, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
mode.of.arrival.any$model6.1.ts.plot
mode.of.arrival.any$model6.1.forest$forest
mode.of.arrival.any$model6.1.panelar.all$coef[3:8] %>% kable(caption = mode.of.arrival.any$model6.1.panelar.all$caption)
```
...
```{r mode_of_arrival_any_model6_2, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
mode.of.arrival.any$model6.2.ts.plot
mode.of.arrival.any$model6.2.forest$forest
mode.of.arrival.any$model6.2.panelar.all$coef[3:8] %>% kable(caption = mode.of.arrival.any$model6.2.panelar.all$caption)
```
...
mode.of.arrival.any$model7.forest$forest
mode.of.arrival.any$model7.panelar.all$coef[3:8] %>% kable(caption = mode.of.arrival.any$model7.panelar.all$caption)
```
