...
mode.of.arrival.any$model6.ts.plot
mode.of.arrival.any$model6.forest$forest
mode.of.arrival.any$model6.panelar.all$coef[3:8] %>% kable(caption = mode.of.arrival.any$model6.panelar.all$caption)
```
