...
```{r mode_of_arrival_any_time_series_plot_case, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
...
```{r mode_of_arrival_any_time_series_plot_control, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
closed_ts_plot(indicator = 'ed attendances',
               sub.indicator = 'any',
               steps = TRUE,
               theme = theme_bw(),
