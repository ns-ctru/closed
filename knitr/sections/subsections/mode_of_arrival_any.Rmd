...
```{r mode_of_arrival_any_model2_5, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
...
## mode.of.arrival.any$model4.ts.plot.lsoa
```
...
```{r mode_or_arrival_any_model5, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
...
```{r mode_or_arrival_any_model6, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
...
```{r mode_or_arrival_any_model7, echo = FALSE, cache = FALSE, results = 'markup', eval = FALSE}
