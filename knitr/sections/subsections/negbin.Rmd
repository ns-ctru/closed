...
## Model 0.5 Prais-Winsten regression
formula.model0.5 <- reformulate(response = 'value',
                                termlabels = c('relative.month', 'closure'))
model0.5.panelar.bishop <- panelAR(data      = ed_attendances_by_mode_site_measure_clean,
