...
```{r critical_care_cips_all_model3a, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
critical.care.cips.all$model3a.ts.plot
critical.care.cips.all$model3a.forest$forest
critical.care.cips.all$model3a.panelar.all$coef[3:8] %>% kable(caption = critical.care.cips.all$model3a.panelar.all$caption)
```
...
```{r critical_care_cips_all_model3b, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
critical.care.cips.all$model3b.ts.plot
critical.care.cips.all$model3b.forest$forest
critical.care.cips.all$model3b.panelar.all$coef[3:8] %>% kable(caption = critical.care.cips.all$model3b.panelar.all$caption)
```
...
critical.care.cips.all$model6.ts.plot
critical.care.cips.all$model6.forest$forest
critical.care.cips.all$model6.panelar.all$coef[3:8] %>% kable(caption = critical.care.cips.all$model6.panelar.all$caption)
```
