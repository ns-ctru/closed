...
ambulance.mean.times.call.to.dest$model1.panelar.all$coef[3:8] %>% kable(caption = ambulance.mean.times.call.to.dest$model1.panelar.all$caption)
```
...
ambulance.mean.times.call.to.dest$model2.panelar.all$coef[3:8] %>% kable(caption = ambulance.mean.times.call.to.dest$model2.panelar.all$caption)
```
...
ambulance.mean.times.call.to.dest$model3a.panelar.all$coef[3:8] %>% kable(caption = ambulance.mean.times.call.to.dest$model3a.panelar.all$caption)
```
...
ambulance.mean.times.call.to.dest$model3b.panelar.all$coef[3:8] %>% kable(caption = ambulance.mean.times.call.to.dest$model3b.panelar.all$caption)
```
...
ambulance.mean.times.call.to.dest$model4.panelar.all$coef[3:9] %>% kable(caption = ambulance.mean.times.call.to.dest$model4.panelar.all$caption)
```
...
ambulance.mean.times.call.to.dest$model5.panelar.all$coef[3:9] %>% kable(caption = ambulance.mean.times.call.to.dest$model5.panelar.all$caption)
```
...
ambulance.mean.times.call.to.dest$model6.panelar.all$coef[3:8] %>% kable(caption = ambulance.mean.times.call.to.dest$model6.panelar.all$caption)
```
...
ambulance.mean.times.call.to.dest$model7.panelar.all$coef[3:8] %>% kable(caption = ambulance.mean.times.call.to.dest$model7.panelar.all$caption)
```
