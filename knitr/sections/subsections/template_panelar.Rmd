...
template$model1.panelar.all$coef[,3:ncol(template$model1.panelar.all$coef)] %>% kable(caption = template$model1.panelar.all$caption)
```
...
template$model2.panelar.all$coef[,3:ncol(template$model2.panelar.all$coef)] %>% kable(caption = template$model2.panelar.all$caption)
```
...
template$model3.1.panelar.all$coef[,3:ncol(template$model3.1.panelar.all$coef)] %>% kable(caption = template$model3.1.panelar.all$caption)
```
...
template$model3.2.panelar.all$coef[,3:ncol(template$model3.2.panelar.all$coef)] %>% kable(caption = template$model3.2.panelar.all$caption)
```
...
template$model4.panelar.all$coef[,3:ncol(template$model4.panelar.all$coef)] %>% kable(caption = template$model4.panelar.all$caption)
```
...
template$model5.panelar.all$coef[,3:ncol(template$model5.panelar.all$coef)] %>% kable(caption = template$model5.panelar.all$caption)
```
...
template$model6.1.panelar.all$coef[,3:ncol(template$model6.1.panelar.all$coef)] %>% kable(caption = template$model6.1.panelar.all$caption)
```
...
template$model6.2.panelar.all$coef[,3:ncol(template$model6.2.panelar.all$coef)] %>% kable(caption = template$model6.2.panelar.all$caption)
```
...
template$model7.panelar.all$coef[,3:ncol(template$model7.panelar.all$coef)] %>% kable(caption = template$model7.panelar.all$caption)
```
