...
cp negbin_template1.Rmd negbin_arrival_amb_model1.Rmd
...
cp negbin_template2.Rmd negbin_arrival_amb_model4.Rmd
...
# cp negbin_template1.Rmd negbin_em_admissions_model1.Rm
...
# cp negbin_template2.Rmd negbin_em_admissions_model4.Rmd
