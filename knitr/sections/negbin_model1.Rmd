...
tsglm_est$est_negbin_exp <- exp(tsglm_est$est_negbin)
...
compare_coef_model1 <- mutate(compare_coef_model1,
                               prais_percent = 100 * (mean_before - est_prais) / mean_before)
...
dplyr::select(site, mean_before, mean_after, diff, diff_perc, est_prais, prais_percent, est_negbin)
