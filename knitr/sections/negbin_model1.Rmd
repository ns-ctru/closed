...
dplyr::select(site, mean_before, mean_after, diff, diff_perc, est_prais, est_negbin)
names(to.table) <- c('Site', 'Pre-Mean', 'Post-Mean', 'Difference', 'Percent', 'Prais-Winsten', 'Negative-Binomial (exponentiated)')
