...
#### Green Calls Hospital Transfers  {.tabset .tabset-fade .tabset-pills}
```{r child = 'subsections/ambulance_non_conveyances_green_calls_hospital_transfers.Rmd', eval = TRUE}
```
...
### Ambulance Red Calls  {.tabset .tabset-fade}
