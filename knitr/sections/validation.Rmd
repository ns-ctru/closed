...
validate.model4 <- merge(dplyr::select(mode.of.arival.any$model4.panelar$coef, Term, All),
                         stata.model4,
			 by    = 'Term',
			 all   = TRUE)
## Model 5
...
validate.model5 <- merge(dplyr::select(mode.of.arival.any$model5.panelar$coef, Term, All),
                         stata.model5,
			 by    = 'Term',
			 all   = TRUE)
