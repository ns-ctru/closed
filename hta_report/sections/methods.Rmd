...
|------------|-------------|--------------|------------------------
| **Deaths** | Mortality rate for deaths occurring upto 3 days for 16 conditions (see table Avoidable Deaths | Count | ONS / HES-ONS|
...
For outcomes that are counts negative-binomial time-series regression is utilised, and where multiple centres are included random effects are allow for variation between the panels.  For ratios and means Prais-Winsten regression (@prais1954).  Across all models maximumisation was performed using likelihood.
