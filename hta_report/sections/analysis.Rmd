...
## Write site and lsoa level data to *.dta for loading into Stata
dplyr::filter(ed_attendances_by_mode_site_measure_clean, sub.measure == 'any') %>%
    write.dta(file = '~/work/closed/hta_report/data/site.dta')
dplyr::filter(ed_attendances_by_mode_measure, sub.measure == 'any') %>%
    write.dta(file = '~/work/closed/hta_report/data/lsoa.dta')
## Run Negative Binomial Analyses in Stata
system('stata -b do ~/work/closed/hta_report/do/negbin.do site.dta lsoa.dta')
