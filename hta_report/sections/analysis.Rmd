...
```{r case_fatality_ratio_trauma, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
case.fatality.ratio.trauma <- closed_models(df.lsoa         = case_fatality_measure,
                                     df.trust         = case_fatality_site_measure,
                                     indicator        = 'case fatality ratio',
                                     sub.indicator    = 'trauma',
                                     panel.lsoa       = model.opts$panel.lsoa,
                                     panel.trust      = model.opts$panel.trust,
                                     timevar          = model.opts$timevar,
                                     outcome          = model.opts$outcome,
...
save(diff.time.to.ed,
     ...
     sec.deaths.all.cips.7days.any.sec,
