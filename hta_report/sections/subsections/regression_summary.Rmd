...
##### Coefficient
```{r closed_heatmap_bishop_coefficient, echo = FALSE, cache = FALSE, results = 'hide', fig.height = 18, fig.width = 12,  eval = TRUE}
heatmap.coefficients$bishop

```

##### P-value
```{r closed_heatmap_bishop_pvalue, echo = FALSE, cache = FALSE, results = 'hide', fig.height = 18, fig.width = 12,  eval = TRUE}
...
##### Coefficient
```{r closed_heatmap_hartlepool_coefficient, echo = FALSE, cache = FALSE, results = 'hide', fig.height = 18, fig.width = 12,  eval = TRUE}
heatmap.coefficients$hartlepool

```

##### P-value
```{r closed_heatmap_hartlepool_pvalue, echo = FALSE, cache = FALSE, results = 'hide', fig.height = 18, fig.width = 12,  eval = TRUE}
...
##### Coefficient
```{r closed_heatmap_hemel_coefficient, echo = FALSE, cache = FALSE, results = 'hide', fig.height = 18, fig.width = 12,  eval = TRUE}
heatmap.coefficients$hemel

```

##### P-value
```{r closed_heatmap_hemel_pvalue, echo = FALSE, cache = FALSE, results = 'hide', fig.height = 18, fig.width = 12,  eval = TRUE}
...
##### Coefficient
```{r closed_heatmap_newark_coefficient, echo = FALSE, cache = FALSE, results = 'hide', fig.height = 18, fig.width = 12,  eval = TRUE}
heatmap.coefficients$newark

```

##### P-value
```{r closed_heatmap_newark_pvalue, echo = FALSE, cache = FALSE, results = 'hide', fig.height = 18, fig.width = 12,  eval = TRUE}
...
##### Coefficient
```{r closed_heatmap_rochdale_coefficient, echo = FALSE, cache = FALSE, results = 'hide', fig.height = 18, fig.width = 12,  eval = TRUE}
heatmap.coefficients$rochdale

```

##### P-value
```{r closed_heatmap_rochdale_pvalue, echo = FALSE, cache = FALSE, results = 'hide', fig.height = 18, fig.width = 12,  eval = TRUE}
