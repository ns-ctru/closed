...
```{r ambulance_all_calls_total, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = TRUE}
ambulance.all.calls.total <- closed_stata_negbin(df.lsoa =  amb_all_calls_measure,
