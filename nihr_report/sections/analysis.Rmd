...
load('~/work/closed/lib/data/ambulance mean times measure - lsoa - 2017-02-21 14.13.Rda')
load('~/work/closed/lib/data/ambulance mean times measure - site - 2017-02-21 14.13.Rda')
...
sink('~/work/closed/tmp/rochdale_check.txt')
...
table(rochdale_amb_mean_times_site_measure$town
sink()
...
sink('~/work/closed/tmp/rochdale_check.txt', append = TRUE)
print('OLD DATA - THREE SITES')
dplyr::filter(amb_mean_times_site_measure) %>%
group_by(town, sub_measure) %>%
...
load('~/work/closed/lib/data/ambulance all calls measure - lsoa - 2017-01-31 13.23.Rda')
load('~/work/closed/lib/data/ambulance all calls measure - site - 2017-01-31 13.23.Rda')
...
save(model.opts, ts.plot.opts, systematic.outlier, exclude.avoidable, exclude.fatality,
     file = '~/work/closed/nihr_report/data/options.RData')
...
save(check.site,
     file = '~/work/closed/nihr_report/data/check_site.RData')
...
save(spurious,
     file = '~/work/closed/nihr_report/data/spurious_cleaned.RData')
...
sec.deaths.in.cips.7days.any.sec <- closed_stata_negbin(df.lsoa =  sec_deaths_in_cips_7days_measure,
                                           ...
                                           rm.unused.control = model.opts$rm.unused.control,
                                           digits           = 3)
## load('~/work/closed/nihr_report/data/sec_deaths_in_cips_7days_any_sec')
...
## save(file = '~/work/closed/nihr_report/data/summary.RData')
