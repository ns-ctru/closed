...
length_of_stay_site_measure_clean <- closed_clean(df      = length_of_stay_site_measure,
                                                ...
                                                systematic    = systematic.outlier,
                                                balance       = FALSE)
sec_case_fatality_7days_site_measure_clean <- closed_clean(df      = sec_case_fatality_7days_site_measure,
                                                 indicator     = 'sec case fatality 7 days',
                                                 sub.indicator = 'any',
                                                 systematic    = systematic.outlier,
                                                 balance       = FALSE)
sec_deaths_all_7days_site_measure_clean <- closed_clean(df      = sec_deaths_all_7days_site_measure,
                                                 indicator     = 'sec_deaths_all_7days',
                                                 sub.indicator = 'any',
                                                 systematic    = systematic.outlier,
                                                 balance       = FALSE)
sec_deaths_in_cips_7days_site_measure_clean <- closed_clean(df      = sec_deaths_in_cips_7days_site_measure,
                                                 indicator     = 'sec_deaths_in_cips_7days',
                                                 sub.indicator = 'any',
                                                 systematic    = systematic.outlier,
                                                 balance       = FALSE)
sec_deaths_not_in_cips_7days_site_measure_clean <- closed_clean(df      = sec_deaths_not_in_cips_7days_site_measure,
                                                 indicator     = 'sec_deaths_not_in_cips_7days',
                                                 sub.indicator = 'any',
                                                 systematic    = systematic.outlier,
                                                 balance       = FALSE)
...
amb_mean_times_site_measure_clean <- closed_clean(df      = amb_mean_times_site_measure,
                                                ...
                                                systematic    = systematic.outlier,
                                                balance       = FALSE)
amb_green_calls_site_measure_clean <- closed_clean(df      = amb_green_calls_site_measure,
                                                indicator     = 'ambulance mean times',
                                                sub.indicator = 'call_to_dest',
                                                systematic    = systematic.outlier,
                                                balance       = FALSE)
...
length_of_stay_site_measure_clean_sd2 <- closed_clean(df      = length_of_stay_site_measure,
                                                ...
                                                systematic    = systematic.outlier,
                                                balance       = FALSE)
sec_case_fatality_7days_site_measure_clean_sd2 <- closed_clean(df      = sec_case_fatality_7days_site_measure,
                                                 indicator     = 'case fatality ratio',
                                                 sub.indicator = 'any',
                                                 systematic    = systematic.outlier,
                                                 balance       = FALSE)
sec_deaths_all_7days_site_measure_clean_sd2 <- closed_clean(df      = sec_deaths_all_7days_site_measure,
                                                 indicator     = 'case fatality ratio',
                                                 sub.indicator = 'any',
                                                 systematic    = systematic.outlier,
                                                 balance       = FALSE)
sec_deaths_in_cips_7days_site_measure_clean_sd2 <- closed_clean(df      = sec_deaths_in_cips_7days_site_measure,
                                                 indicator     = 'case fatality ratio',
                                                 sub.indicator = 'any',
                                                 systematic    = systematic.outlier,
                                                 balance       = FALSE)
sec_deaths_not_in_cips_7days_site_measure_clean_sd2 <- closed_clean(df      = sec_deaths_not_in_cips_7days_site_measure,
                                                 indicator     = 'case fatality ratio',
                                                 sub.indicator = 'any',
                                                 systematic    = systematic.outlier,
                                                 balance       = FALSE)
...
amb_mean_times_site_measure_clean_sd2 <- closed_clean(df      = amb_mean_times_site_measure,
                                                ...
                                                systematic    = systematic.outlier,
                                                balance       = FALSE)
amb_green_calls_site_measure_clean_sd2 <- closed_clean(df      = amb_green_calls_site_measure,
                                                indicator     = 'ambulance mean times',
                                                sub.indicator = 'call_to_dest',
                                                systematic    = systematic.outlier,
                                                balance       = FALSE)
...
unnecessary.attendance <- closed_stata_negbin(df.lsoa =  unnecessary_ed_attendances_measure,
...
all.emergency.admissions.all <- closed_stata_negbin(df.lsoa =  emergency_admissions_measure,
...
avoidable.emergency.admissions.any <- closed_stata_negbin(df.lsoa =  emergency_admissions_measure,
                                           df.trust         = emergency_admissions_site_measure_clean,
                                           indicator       = 'avoidable emergency admissions',
                                           sub.indicator   = 'any',
                                           return.df       = FALSE,
...
avoidable.emergency.admissions.chest.pain <- closed_stata_negbin(df.lsoa =  emergency_admissions_measure,
                                           df.trust         = emergency_admissions_site_measure_clean,
                                           indicator       = 'avoidable emergency admissions',
...
ed.attendances.admitted.all <- closed_stata_negbin(df.lsoa =  ed_attendances_admitted_measure,
...
ed.attendances.admitted.admitted <- closed_stata_negbin(df.lsoa =  ed_attendances_admitted_measure,
                                           df.trust         = ed_attendances_admitted_site_measure_clean,
                                           indicator       = 'ed attendances admitted',
...
critical.care.cips.all <- closed_stata_negbin(df.lsoa =  critical_care_cips_measure,
...
case.fatality.ratio.any <- closed_models(df.lsoa         = sec_case_fatality_7days_measure,
...
case.fatality.ratio.acute.heart.failure <- closed_models(df.lsoa         = sec_case_fatality_7days_measure,
                                     df.trust         = sec_case_fatality_7days_site_measure,
                                     indicator        = 'sec case fatality 7 days',
...
case.fatality.ratio.myocardial.infarction <- closed_models(df.lsoa         = sec_case_fatality_7days_measure,
                                     df.trust         = sec_case_fatality_7days_site_measure,
                                     indicator        = 'sec case fatality 7 days',
...
case.fatality.ratio.any.trauma.sec <- closed_models(df.lsoa         = sec_case_fatality_7days_measure,
                                     df.trust         = sec_case_fatality_7days_site_measure,
                                     indicator        = 'sec case fatality 7 days',
...
<!-- case.fatality.ratio.serious.head.injury <- closed_models(df.lsoa         = sec_case_fatality_7days_measure, -->
<!--                                      df.trust         = sec_case_fatality_7days_site_measure, -->
<!--                                      indicator        = 'sec case fatality 7 days', -->
...
<!-- case.fatality.ratio.road.traffic.accident <- closed_models(df.lsoa         = sec_case_fatality_7days_measure, -->
<!--                                      df.trust         = sec_case_fatality_7days_site_measure, -->
<!--                                      indicator        = 'sec case fatality 7 days', -->
...
<!-- case.fatality.ratio.falls <- closed_models(df.lsoa         = sec_case_fatality_7days_measure, -->
<!--                                      df.trust         = sec_case_fatality_7days_site_measure, -->
<!--                                      indicator        = 'sec case fatality 7 days', -->
<!--                                      sub.indicator    = 'falls', -->
<!--                                      panel.lsoa       = model.opts$panel.lsoa, -->
...
case.fatality.ratio.stroke.cva <- closed_models(df.lsoa         = sec_case_fatality_7days_measure,
                                     df.trust         = sec_case_fatality_7days_site_measure,
                                     indicator        = 'sec case fatality 7 days',
...
<!-- case.fatality.ratio.7days.any.single.sec <- closed_models(df.lsoa         = sec_case_fatality_7days_measure, -->
<!--                                      df.trust         = sec_case_fatality_7days_site_measure, -->
<!--                                      indicator        = 'sec case fatality 7 days', -->
...
sec.deaths.not.in.cips.7days.any.sec <- closed_stata_negbin(df.lsoa =  sec_deaths_not_in_cips_7days_measure,
