...
rochdale_amb_mean_times_measure <- dplyr::filter(rochdale_amb_mean_times_measure, town == 'Rochdale')
rochdale_amb_mean_times_site_measure <- dplyr::filter(rochdale_amb_mean_times_site_measure, town == 'Rochdale')
group_by(amb_mean_times_site_measure, town, sub_measure) %>%
    dplyr::summary(mean = mean(value, na.rm = TRUE))
...
group_by(amb_mean_times_site_measure, town, sub_measure) %>%
    dplyr::summary(mean = mean(value, na.rm = TRUE))
amb_mean_times_measure <- rbind(dplyr::filter(amb_mean_times_measure, town != 'Rochdale'),
                                rochdale_amb_mean_times_measure, town == 'Rochdale')
amb_mean_times_site_measure <- rbind(dplyr::filter(amb_mean_times_site_measure, town != 'Rochdale'),
                                     rochdale_amb_mean_times_site_measure, town == 'Rochdale')
group_by(amb_mean_times_site_measure, town, sub_measure) %>%
    dplyr::summary(mean = mean(value, na.rm = TRUE))
