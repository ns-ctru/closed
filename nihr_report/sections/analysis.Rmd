...
load('~/work/scharr/closed/lib/data/ambulance green calls measure - lsoa - 2016-11-21 20.33.Rda')
load('~/work/scharr/closed/lib/data/ambulance green calls measure - site - 2016-11-21 20.33.Rda')
## load('~/work/scharr/closed/lib/data/ambulance green calls measure - lsoa - 2016-10-13 17.10.Rda')
## load('~/work/scharr/closed/lib/data/ambulance green calls measure - site - 2016-10-13 17.11.Rda')
load('~/work/scharr/closed/lib/data/ambulance mean times measure - lsoa - 2017-02-21 14.13.Rda')
load('~/work/scharr/closed/lib/data/ambulance mean times measure - site - 2017-02-21 14.13.Rda')
## 2017-02-21 - Only need Rochdale from these files as they're the only ones that change
rochdale_amb_mean_times_measure <- dplyr::filter(amb_mean_times_measure, town == 'Rochdale')
rochdale_amb_mean_times_site_measure <- dplyr::filter(amb_mean_times_site_measure, town == 'Rochdale')
sink('~/work/scharr/closed/tmp/rochdale_check.txt')
print('NEW DATA - THREE SITES')
dplyr::filter(amb_mean_times_site_measure, town %in% c('Bishop Auckland', 'Rochdale', 'Southport')) %>%
group_by(town, sub_measure) %>%
    dplyr::summarise(mean = mean(value, na.rm = TRUE)) %>% as.data.frame()
sink()
...
## 2017-02-21 - Only need non-Rochdale from these files
sink('~/work/scharr/closed/tmp/rochdale_check.txt', append = TRUE)
print('OLD DATA - THREE SITES')
dplyr::filter(amb_mean_times_site_measure, town %in% c('Bishop Auckland', 'Rochdale', 'Southport')) %>%
group_by(town, sub_measure) %>%
dplyr::summarise(mean = mean(value, na.rm = TRUE)) %>% as.data.frame() %>% ungroup()
amb_mean_times_measure <- dplyr::filter(amb_mean_times_measure, town != 'Rochdale')
amb_mean_times_measure <- rbind(amb_mean_times_measure,
                                rochdale_amb_mean_times_measure)
amb_mean_times_site_measure <- dplyr::filter(amb_mean_times_site_measure, town != 'Rochdale')
amb_mean_times_site_measure <- rbind(amb_mean_times_site_measure,
                                     rochdale_amb_mean_times_site_measure)
print('COMBINED DATA - CORRECT????')
dplyr::filter(amb_mean_times_site_measure, town %in% c('Bishop Auckland', 'Rochdale', 'Southport')) %>%
group_by(town, sub_measure) %>%
    dplyr::summarise(mean = mean(value, na.rm = TRUE)) %>% as.data.frame()
sink()
## load('~/work/scharr/closed/lib/data/ambulance mean times measure - lsoa - 2016-10-13 16.45.Rda')
## load('~/work/scharr/closed/lib/data/ambulance mean times measure - site - 2016-10-13 16.46.Rda')
## load('~/work/scharr/closed/lib/data/ambulance mean times measure - lsoa - 2016-09-02 15.21.Rda')
## load('~/work/scharr/closed/lib/data/ambulance mean times measure - site - 2016-09-02 15.22.Rda')
## load('~/work/scharr/closed/lib/data/ambulance mean times measure - lsoa - 2016-08-01 17.14.Rda')
## load('~/work/scharr/closed/lib/data/ambulance mean times measure - site - 2016-08-01 17.14.Rda')
## load('~/work/scharr/closed/lib/data/ambulance mean times measure - lsoa - 2016-07-19 14.12.Rda')
## load('~/work/scharr/closed/lib/data/ambulance mean times measure - site - 2016-07-19 14.12.Rda')
## load('~/work/scharr/closed/lib/data/ambulance mean times measure - lsoa - 2016-06-17 01.21.Rda')
## load('~/work/scharr/closed/lib/data/ambulance mean times measure - site - 2016-06-17 01.23.Rda')
load('~/work/scharr/closed/lib/data/ambulance red calls measure - lsoa - 2016-11-21 20.31.Rda')
load('~/work/scharr/closed/lib/data/ambulance red calls measure - site - 2016-11-21 20.32.Rda')
## load('~/work/scharr/closed/lib/data/ambulance red calls measure - lsoa - 2016-10-12 12.52.Rda')
## load('~/work/scharr/closed/lib/data/ambulance red calls measure - site - 2016-10-12 12.52.Rda')
...
## load('~/work/scharr/closed/lib/data/ambulance red calls measure - lsoa - 2016-08-01 17.15.Rda')
## load('~/work/scharr/closed/lib/data/ambulance red calls measure - site - 2016-08-01 17.15.Rda')
## load('~/work/scharr/closed/lib/data/ambulance red calls measure - lsoa - 2016-07-15 20.11.Rda')
## load('~/work/scharr/closed/lib/data/ambulance red calls measure - site - 2016-07-15 20.11.Rda')
## 2017-01-31 - All Ambulance Calls
load('~/work/scharr/closed/lib/data/ambulance all calls measure - lsoa - 2017-01-31 13.23.Rda')
load('~/work/scharr/closed/lib/data/ambulance all calls measure - site - 2017-01-31 13.23.Rda')
...
## load('~/work/scharr/closed/lib/data/case fatality measure - lsoa - 2016-06-10 18.09.Rda')
## load('~/work/scharr/closed/lib/data/case fatality measure - site - 2016-06-10 18.10.Rda')
...
## load('~/work/scharr/closed/lib/data/critical care stays measure - lsoa - 2016-06-10 18.17.Rda')
## load('~/work/scharr/closed/lib/data/critical care stays measure - site - 2016-06-10 18.18.Rda')
## load('~/work/scharr/closed/lib/data/critical care stays measure - lsoa - 2016-05-24 14.32.Rda')
## load('~/work/scharr/closed/lib/data/critical care stays measure - site - 2016-05-24 14.32.Rda')
...
## load('~/work/scharr/closed/lib/data/ed attendances admitted measure - lsoa - 2016-05-24 14.28.Rda')
## load('~/work/scharr/closed/lib/data/ed attendances admitted measure - site - 2016-05-24 14.28.Rda')
...
## load('~/work/scharr/closed/lib/data/ed attendances by mode measure - lsoa - 2016-05-24 14.25.Rda')
## load('~/work/scharr/closed/lib/data/ed attendances by mode measure - site - 2016-05-24 14.26.Rda')
...
## load('~/work/scharr/closed/lib/data/emergency admissions measure - lsoa - 2016-05-24 14.30.Rda')
## load('~/work/scharr/closed/lib/data/emergency admissions measure - site - 2016-05-24 14.31.Rda')
...
## load('~/work/scharr/closed/lib/data/hospital transfers measure - lsoa - 2016-09-02 13.05.Rda')
## load('~/work/scharr/closed/lib/data/hospital transfers measure - site - 2016-09-02 13.06.Rda')
...
## load('~/work/scharr/closed/lib/data/length of stay measure - lsoa - 2016-05-24 14.34.Rda')
## load('~/work/scharr/closed/lib/data/length of stay measure - site - 2016-05-24 14.35.Rda')
 load('~/work/scharr/closed/lib/data/sec case fatality 7days measure - lsoa - 2016-11-24 18.46.Rda')
 load('~/work/scharr/closed/lib/data/sec case fatality 7days measure - site - 2016-11-24 18.46.Rda')
## load('~/work/scharr/closed/lib/data/sec case fatality 7days measure - lsoa - 2016-11-23 16.21.Rda')
## load('~/work/scharr/closed/lib/data/sec case fatality 7days measure - site - 2016-11-23 16.21.Rda')
load('~/work/scharr/closed/lib/data/sec deaths all 7days measure - lsoa - 2016-11-24 18.42.Rda')
load('~/work/scharr/closed/lib/data/sec deaths all 7days measure - site - 2016-11-24 18.43.Rda')
## load('~/work/scharr/closed/lib/data/sec deaths all 7days measure - lsoa - 2016-11-23 16.17.Rda')
## load('~/work/scharr/closed/lib/data/sec deaths all 7days measure - site - 2016-11-23 16.18.Rda')
load('~/work/scharr/closed/lib/data/sec deaths in cips 7days measure - lsoa - 2016-11-24 18.42.Rda')
load('~/work/scharr/closed/lib/data/sec deaths in cips 7days measure - site - 2016-11-24 18.43.Rda')
## load('~/work/scharr/closed/lib/data/sec deaths in cips 7days measure - lsoa - 2016-11-23 16.17.Rda')
## load('~/work/scharr/closed/lib/data/sec deaths in cips 7days measure - site - 2016-11-23 16.18.Rda')
load('~/work/scharr/closed/lib/data/sec deaths not in cips 7days measure - lsoa - 2016-11-24 18.43.Rda')
load('~/work/scharr/closed/lib/data/sec deaths not in cips 7days measure - site - 2016-11-24 18.43.Rda')
## load('~/work/scharr/closed/lib/data/sec deaths not in cips 7days measure - lsoa - 2016-11-23 16.18.Rda')
## load('~/work/scharr/closed/lib/data/sec deaths not in cips 7days measure - site - 2016-11-23 16.18.Rda')
...
## load('~/work/scharr/closed/lib/data/unnecessary ed attendances measure - lsoa - 2016-05-24 14.26.Rda')
## load('~/work/scharr/closed/lib/data/unnecessary ed attendances measure - site - 2016-05-24 14.26.Rda')
...
amb_all_calls_measure                     <- closed_tidy(amb_all_calls_measure)
amb_all_calls_site_measure                <- closed_tidy(amb_all_calls_site_measure)
...
## 2016-01-05 - Modified pooled model on request
...
model.opts$mod8       <- c('diff.time.to.ed * closure', 'nhs111', 'other.centre', 'ambulance.divert', 'relative.month', 'season')
## model.opts$mod8 <- NULL
...
model.opts$remove.spurious   <- TRUE
...
save(model.opts, ts.plot.opts, systematic.outlier, exclude.avoidable, exclude.fatality,
     file = '~/work/scharr/closed/nihr_report/data/options.RData')
...
check.all.calls                    <- closed_missing_summary(df.lsoa = amb_all_calls_measure,
                                                             df.site = amb_all_calls_site_measure)
...
## Summarise the number of missing months rather than just tabulating the actual months
## required for reviewers comments
check.site.reviewers <- check.site %>%
                        group_by(town, measure, sub.measure) %>%
                        summarise(n = n()) %>%
                        dcast(measure + sub.measure ~ town)
names(check.site) <- c('Measure', 'Sub-Measure', 'Town', 'Relative Month')
save(check.site,
     file = '~/work/scharr/closed/nihr_report/data/check_site.RData')
...
amb_red_calls_site_measure_clean <- closed_clean_revised(df      = amb_red_calls_site_measure,
                                                           ...
                                                           systematic    = systematic.outlier,
                                                           lsoa          = FALSE)
amb_all_calls_site_measure_clean <- closed_clean_revised(df      = amb_all_calls_site_measure,
                                                           indicator     = 'ambulance all calls',
                                                           systematic    = systematic.outlier,
                                                           lsoa          = FALSE)
...
amb_red_calls_measure_clean <- closed_clean_revised(df      = amb_red_calls_measure,
                                                          ...
                                                          systematic    = systematic.outlier,
                                                          lsoa          = TRUE)
amb_all_calls_measure_clean <- closed_clean_revised(df      = amb_all_calls_measure,
                                                          indicator     = 'ambulance mean times',
                                                          systematic    = systematic.outlier,
                                                          lsoa          = TRUE)
...
amb_red_calls_site_measure_clean_sd2 <- closed_clean_revised(df      = amb_red_calls_site_measure,
                                                indicator     = 'ambulance mean times',
                                                systematic    = systematic.outlier)
amb_all_calls_site_measure_clean_sd2 <- closed_clean_revised(df      = amb_all_calls_site_measure,
                                                indicator     = 'ambulance mean times',
                                                systematic    = systematic.outlier)
...
spurious2 <- rbind(ed_attendances_by_mode_site_measure_clean_sd2,
                   ...
                   amb_all_calls_site_measure_clean_sd2,
...
save(spurious,
     file = '~/work/scharr/closed/nihr_report/data/spurious_cleaned.RData')
...
```{r avoidable_emergency_admissions_any, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
...
```{r case_fatality_ratio_any_trauma_sec, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
...
<!-- ```{r sec_case_fatality_7days_ratio_falls, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE} -->
...
<!-- ```{r case_fatality_ratio_7days_any_single_sec, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE} -->
...
```{r case_fatality_ratio_7days_any_sec, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
...
```{r sec_deaths_all_7days_any_sec, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
...
```{r sec_deaths_in_cips_7days_any_sec, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
sec.deaths.in.cips.7days.any.sec <- closed_stata_negbin(df.lsoa =  sec_deaths_in_cips_7days_measure,
                                           ...
                                           rm.unused.control = model.opts$rm.unused.control,
                                           digits           = 3)
## load('~/work/scharr/closed/nihr_report/data/sec_deaths_in_cips_7days_any_sec')

```

<!--- Sec Deaths NOT in CIPS (7 days) - Any sec --->
```{r sec_deaths_not_in_cips_7days_any_sec, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
...
ambulance.mean.times.scene.to.dest <- closed_models(df.lsoa         = amb_mean_times_measure_clean,
                                     df.trust         = amb_mean_times_site_measure_clean,
                                     indicator        = 'ambulance mean times',
...
ambulance.non.conveyances.green.calls <- closed_stata_negbin(df.lsoa =  amb_green_calls_measure_clean,
...
```{r ambulance_non_conveyances_green_calls_hospital_transfers, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
...
<!--- Ambulance All Calls - Total --->
```{r ambulance_all_calls_total, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
ambulance.all.calls.total <- closed_stata_negbin(df.lsoa =  amb_all_calls_measure_clean,
                                           df.trust         = amb_all_calls_site_measure_clean,
                                           indicator       = 'ambulance all calls',
                                           sub.indicator   = 'total',
                                           return.df       = FALSE,
                                           return.model    = TRUE,
...
```{r hospital_transfers_all_stays, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
...
```{r hospital_transfers_stays_with_transfer, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
...
```{r hospital_transfers_proportion_with_transfer, echo = FALSE, cache = FALSE, results = 'hide', message = FALSE, eval = FALSE}
...
summary.models <- rbind(mode.of.arrival.any$all.model.all.coef,
                        ...
                        ambulance.all.calls.total$all.model.all.coef,
...
## save(file = '~/work/scharr/closed/nihr_report/data/summary.RData')
save(diff.time.to.ed,
     ...
     ## results,
     ## closure,
     file = '~/work/scharr/closed/nihr_report/data/results.RData')
...
## load(file = '~/work/scharr/closed/lib/data/summary.RData')
## load(file = '~/work/scharr/closed/lib/data/results.regression.RData')
