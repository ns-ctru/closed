...
to.table <- dplyr::select(no.nhs.all.emergency.admissions.all$summary.table.rochdale, town, Before_mean.sd, Before_median.iqr, Before_min.max, After_mean.sd, After_median.iqr, After_min.max, diff_abs, diff_perc) %>%
...
to.table <- dplyr::select(all.emergency.admissions.all$summary.table.rochdale, town, Before_mean.sd, Before_median.iqr, Before_min.max, After_mean.sd, After_median.iqr, After_min.max, diff_abs, diff_perc) %>%
             mutate(Before_median.iqr = ifelse(Before_median.iqr == 'Model 4',
                                      yes = 'Model 3',
                                      no  = Before_median.iqr),
           Before_median.iqr = ifelse(Before_median.iqr == 'Model 6.1',
