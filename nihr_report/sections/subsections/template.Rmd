...
sites <- c('Bishop Auckland', 'Hartlepool', 'Hemel Hempstead', 'Newark', 'Rochdale')
## Filter
to.plot <- dplyr::filter(data_frame_site_measure_clean,
                  town %in% sites &
                  measure == measure,
...
kable(to.table, caption = 'Summary statistics Pre/Post closure and estimated coefficients for the closure or difference in time to ED (depending on the outcome)')
