...
Ambulance Non-Conveyance | `amb_non_conveyance_site_measure`   | `ambulance non-conveyance` | `green calls`
Ambulance Non-Conveyance | `amb_non_conveyance_site_measure`   | `ambulance non-conveyance` | `not conveyed green calls`
Ambulance Non-Conveyance | `amb_non_conveyance_site_measure`   | `ambulance non-conveyance` | `fraction not conveyed`
Ambulance Red Calls      | `amb_red_calls_site_measure` | `ambulance red calls` | `hospital transfers`
Ambulance Red Calls      | `amb_red_calls_site_measure` | `ambulance red calls` | `total`
