...
kable(spurious.data,
      caption = paste0('Spurious Data Points identified based on visual inspection.\n', 'Generated : ', Sys.time()))
...
```{r spurious_data_points, echo = FALSE, cache = FALSE, results = 'markup', message = FALSE, fig.height = 16, eval = TRUE}
