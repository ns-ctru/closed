...
closed_models <- function(df.lsoa         = ed_attendances_by_mode_measure,
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 0']               <- 'Estimated closure coefficients'
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 0.5']               <- 'Estimated closure coefficients'
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 1']               <- 'Estimated closure coefficients'
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 2']               <- 'Estimated closure coefficients'
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 3.1']               <- 'Estimated closure coefficients'
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 3.2']               <- 'Estimated closure coefficients'
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 4']               <- 'Estimated closure coefficients'
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 5']               <- 'Estimated closure coefficients'
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 6.1']               <- 'Estimated difference in time to ED coefficient'
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 6.2']               <- 'Estimated difference in time to ED coefficient'
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 7.1']               <- 'Estimated difference in time to ED coefficient'
    ...
    results$summary.tableBefore_mean.sd[results$summary.table$Before_median.iqr == 'Model 7.2']               <- 'Estimated difference in time to ED coefficient'
    ...
    results$summary.table$town <- results$summary.table$group
