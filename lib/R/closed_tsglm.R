...
closed_tsglm <- function(df.lsoa          = ed_attendances_by_mode_measure,
    ...
    if(!is.null(model0)){
        ...
        if(town.group$n[town.group$town == 'Bishop Auckland'] > 0){
            ...
            results$model0.tsglm.bishop.coef$site          <- 'Bishop Auckland'
            results$model0.tsglm.bishop.coef$indicator     <- indicator
            results$model0.tsglm.bishop.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 0 - Hartlepool                         ##
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Hartlepool'] > 0){
            ...
            results$model0.tsglm.hartlepool.coef$site          <- 'Hartlepool'
            results$model0.tsglm.hartlepool.coef$indicator     <- indicator
            results$model0.tsglm.hartlepool.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Hemel Hempstead'] > 0){
            ...
            results$model0.tsglm.hemel.coef$site          <- 'Hemel Hempstead'
            results$model0.tsglm.hemel.coef$indicator     <- indicator
            results$model0.tsglm.hemel.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 0 - Newark                             ##
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Newark'] > 0){
            ...
            results$model0.tsglm.newark.coef$site          <- 'Newark'
            results$model0.tsglm.newark.coef$indicator     <- indicator
            results$model0.tsglm.newark.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 0 - Rochdale                           ##
        ##################################################
    ...
    if(!is.null(model1)){
        ...
        if(town.group$n[town.group$town == 'Bishop Auckland'] > 0){
            ...
            results$model1.tsglm.bishop.coef$site          <- 'Bishop Auckland'
            results$model1.tsglm.bishop.coef$indicator     <- indicator
            results$model1.tsglm.bishop.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 1 - Hartlepool                         ##
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Hartlepool'] > 0){
            ...
            results$model1.tsglm.hartlepool.coef$site          <- 'Hartlepool'
            results$model1.tsglm.hartlepool.coef$indicator     <- indicator
            results$model1.tsglm.hartlepool.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Hemel Hempstead'] > 0){
            ...
            results$model1.tsglm.hemel.coef$site          <- 'Hemel Hempstead'
            results$model1.tsglm.hemel.coef$indicator     <- indicator
            results$model1.tsglm.hemel.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 1 - Newark                             ##
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Newark'] > 0){
            ...
            results$model1.tsglm.newark.coef$site          <- 'Newark'
            results$model1.tsglm.newark.coef$indicator     <- indicator
            results$model1.tsglm.newark.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 1 - Rochdale                           ##
        ##################################################
    ...
    if(!is.null(model2)){
        ...
        if(town.group$n[town.group$town == 'Bishop Auckland'] > 0){
            ...
            results$model2.tsglm.bishop.coef$site          <- 'Bishop Auckland'
            results$model2.tsglm.bishop.coef$indicator     <- indicator
            results$model2.tsglm.bishop.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 2 - Hartlepool                         ##
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Hartlepool'] > 0){
            ...
            results$model2.tsglm.hartlepool.coef$site          <- 'Hartlepool'
            results$model2.tsglm.hartlepool.coef$indicator     <- indicator
            results$model2.tsglm.hartlepool.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Hemel Hempstead'] > 0){
            ...
            results$model2.tsglm.hemel.coef$site          <- 'Hemel Hempstead'
            results$model2.tsglm.hemel.coef$indicator     <- indicator
            results$model2.tsglm.hemel.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 2 - Newark                             ##
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Newark'] > 0){
            ...
            results$model2.tsglm.newark.coef$site          <- 'Newark'
            results$model2.tsglm.newark.coef$indicator     <- indicator
            results$model2.tsglm.newark.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 2 - Rochdale                           ##
        ##################################################
    ...
    if(!is.null(model3.1)){
        ...
        if(town.group$n[town.group$town == 'Bishop Auckland'] > 0){
            ...
            results$model3.1.tsglm.bishop.coef$site          <- 'Bishop Auckland'
            results$model3.1.tsglm.bishop.coef$indicator     <- indicator
            results$model3.1.tsglm.bishop.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Hartlepool'] > 0){
            ...
            results$model3.1.tsglm.hartlepool.coef$site          <- 'Hartlepool'
            results$model3.1.tsglm.hartlepool.coef$indicator     <- indicator
            results$model3.1.tsglm.hartlepool.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Hemel Hempstead'] > 0){
            ...
            results$model3.1.tsglm.hemel.coef$site          <- 'Hemel Hempstead'
            results$model3.1.tsglm.hemel.coef$indicator     <- indicator
            results$model3.1.tsglm.hemel.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 3.1 - Newark                           ##
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Newark'] > 0){
            ...
            results$model3.1.tsglm.newark.coef$site          <- 'Newark'
            results$model3.1.tsglm.newark.coef$indicator     <- indicator
            results$model3.1.tsglm.newark.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 3.1 - Rochdale                         ##
        ##################################################
    ...
    if(!is.null(model3.2)){
        ...
        ## return(t)
        if(town.group$n[town.group$town == 'Bishop Auckland'] > 0){
            model3.2.tsglm.bishop <- tsglm(ts = ts.vector,
                                         link = tsglm.link,
                                         model = tsglm.model,
                                         xreg  = regressors,
                                         distr = tsglm.distr)
            results$model3.2.tsglm.bishop.coef <- se(model3.2.tsglm.bishop)
            results$model3.2.tsglm.bishop.coef$site          <- 'Bishop Auckland'
            results$model3.2.tsglm.bishop.coef$indicator     <- indicator
            results$model3.2.tsglm.bishop.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Hartlepool'] > 0){
            model3.2.tsglm.hartlepool <- tsglm(ts = ts.vector,
                                             link = tsglm.link,
                                             model = tsglm.model,
                                             xreg  = regressors,
                                             distr = tsglm.distr)
            results$model3.2.tsglm.hartlepool.coef <- se(model3.2.tsglm.hartlepool)
            results$model3.2.tsglm.hartlepool.coef$site          <- 'Hartlepool'
            results$model3.2.tsglm.hartlepool.coef$indicator     <- indicator
            results$model3.2.tsglm.hartlepool.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Hemel Hempstead'] > 0){
            model3.2.tsglm.hemel <- tsglm(ts = ts.vector,
                                        link = tsglm.link,
                                        model = tsglm.model,
                                        xreg  = regressors,
                                        distr = tsglm.distr)
            results$model3.2.tsglm.hemel.coef <- se(model3.2.tsglm.hemel)
            results$model3.2.tsglm.hemel.coef$site          <- 'Hemel Hempstead'
            results$model3.2.tsglm.hemel.coef$indicator     <- indicator
            results$model3.2.tsglm.hemel.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 3.2 - Newark                           ##
        ##################################################
        ...
        regressors <- dplyr::filter(df3.2,
                      ...
                      dplyr::select(town_, closure, town_closure, season2, season3, season4, season5, season6, relative.month, other.centre)
        if(town.group$n[town.group$town == 'Newark'] > 0){
            model3.2.tsglm.newark <- tsglm(ts = ts.vector,
                                         link = tsglm.link,
                                         model = tsglm.model,
                                         xreg  = regressors,
                                         distr = tsglm.distr)
            results$model3.2.tsglm.newark.coef <- se(model3.2.tsglm.newark)
            results$model3.2.tsglm.newark.coef$site          <- 'Newark'
            results$model3.2.tsglm.newark.coef$indicator     <- indicator
            results$model3.2.tsglm.newark.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 3.2 - Rochdale                         ##
        ##################################################
        ...
        if(town.group$n[town.group$town == 'Rochdale'] > 0){
            model3.2.tsglm.rochdale <- tsglm(ts = ts.vector,
                                           link = tsglm.link,
                                           model = tsglm.model,
                                           xreg  = regressors,
                                           distr = tsglm.distr)
            results$model3.2.tsglm.rochdale.coef <- se(model3.2.tsglm.rochdale)
            results$model3.2.tsglm.rochdale.coef$site          <- 'Rochdale'
            results$model3.2.tsglm.rochdale.coef$indicator     <- indicator
            results$model3.2.tsglm.rochdale.coef$sub.indicator <- sub.indicator
        }
        ## Summary table
        results$model3.2.tsglm.coefficients <- combine_coefficients(bishop.coef     = results$model3.2.tsglm.bishop.coef,
                                                                  hartlepool.coef = results$model3.2.tsglm.hartlepool.coef,
                                                                  hemel.coef      = results$model3.2.tsglm.hemel.coef,
                                                                  newark.coef     = results$model3.2.tsglm.newark.coef,
        ...
        ## Return model objects if requested
        if(return.model == TRUE){
            if(exists('model3.2.tsglm.bishop')){
                results$model3.2.tsglm.bishop     <- model3.2.tsglm.bishop
            }
            if(exists('model3.2.tsglm.hartlepool')){
                results$model3.2.tsglm.hartlepool <- model3.2.tsglm.hartlepool
            }
            if(exists('model3.2.tsglm.hemel')){
                results$model3.2.tsglm.hemel      <- model3.2.tsglm.hemel
            }
            if(exists('model3.2.tsglm.newark')){
                results$model3.2.tsglm.newark     <- model3.2.tsglm.newark
            }
            if(exists('model3.2.tsglm.rochdale')){
                results$model3.2.tsglm.rochdale   <- model3.2.tsglm.rochdale
            }
        }
        if(return.df == TRUE){
        ...
        if(return.residuals == TRUE){
            if(exists('model3.2.tsglm.bishop')){
                results$model3.2.tsglm.residuals.bishop     <- summary(model3.2.tsglm.bishop)$residuals
            }
            if(exists('model3.2.tsglm.hartlepool')){
                results$model3.2.tsglm.residuals.hartlepool <- summary(model3.2.tsglm.hartlepool)$residuals
            }
            if(exists('model3.2.tsglm.hemel')){
                results$model3.2.tsglm.residuals.hemel      <- summary(model3.2.tsglm.hemel)$residuals
            }
            if(exists('model3.2.tsglm.newark')){
                results$model3.2.tsglm.residuals.newark     <- summary(model3.2.tsglm.newark)$residuals
            }
            if(exists('model3.2.tsglm.rochdale')){
                results$model3.2.tsglm.residuals.rochdale   <- summary(model3.2.tsglm.rochdale)$residuals
            }
        }
        ## Remove clutter
        rm(df3.2)
    ...
    if(!is.null(model5)){
        ...
        ## Summary table
        results$model5.tsglm.coefficients <- combine_coefficients(bishop.coef     = results$model3.1.tsglm.bishop.coef,
                                                                  hartlepool.coef = results$model3.1.tsglm.hartlepool.coef,
                                                                  hemel.coef      = results$model3.1.tsglm.hemel.coef,
                                                                  newark.coef     = results$model3.1.tsglm.newark.coef,
                                                                  rochdale.coef   = results$model3.1.tsglm.rochdale.coef,
    ...
    if(!is.null(model6.1)){
        ...
        ## return(t)
        if(town.group$n[town.group$town == 'Bishop Auckland'] > 0){
            model6.1.tsglm.bishop <- tsglm(ts = ts.vector,
                                         link = tsglm.link,
                                         model = tsglm.model,
                                         xreg  = regressors,
                                         distr = tsglm.distr)
            results$model6.1.tsglm.bishop.coef <- se(model6.1.tsglm.bishop)
            results$model6.1.tsglm.bishop.coef$site          <- 'Bishop Auckland'
            results$model6.1.tsglm.bishop.coef$indicator     <- indicator
            results$model6.1.tsglm.bishop.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ...
        regressors <- dplyr::filter(df6.1,
                      ...
                      dplyr::select(closure, season2, season3, season4, season5, season6, relative.month, nhs111, other.centre)
        if(town.group$n[town.group$town == 'Hartlepool'] > 0){
            model6.1.tsglm.hartlepool <- tsglm(ts = ts.vector,
                                             link = tsglm.link,
                                             model = tsglm.model,
                                             xreg  = regressors,
                                             distr = tsglm.distr)
            results$model6.1.tsglm.hartlepool.coef <- se(model6.1.tsglm.hartlepool)
            results$model6.1.tsglm.hartlepool.coef$site          <- 'Hartlepool'
            results$model6.1.tsglm.hartlepool.coef$indicator     <- indicator
            results$model6.1.tsglm.hartlepool.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ...
        regressors <- dplyr::filter(df6.1,
                      ...
                      dplyr::select(closure, season2, season3, season4, season5, season6, relative.month, other.centre)
        if(town.group$n[town.group$town == 'Hemel Hempstead'] > 0){
            model6.1.tsglm.hemel <- tsglm(ts = ts.vector,
                                        link = tsglm.link,
                                        model = tsglm.model,
                                        xreg  = regressors,
                                        distr = tsglm.distr)
            results$model6.1.tsglm.hemel.coef <- se(model6.1.tsglm.hemel)
            results$model6.1.tsglm.hemel.coef$site          <- 'Hemel Hempstead'
            results$model6.1.tsglm.hemel.coef$indicator     <- indicator
            results$model6.1.tsglm.hemel.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 6.1 - Newark                             ##
        ##################################################
        ...
        regressors <- dplyr::filter(df6.1,
                      ...
                      dplyr::select(closure, season2, season3, season4, season5, season6, relative.month, other.centre)
        if(town.group$n[town.group$town == 'Newark'] > 0){
            model6.1.tsglm.newark <- tsglm(ts = ts.vector,
                                         link = tsglm.link,
                                         model = tsglm.model,
                                         xreg  = regressors,
                                         distr = tsglm.distr)
            results$model6.1.tsglm.newark.coef <- se(model6.1.tsglm.newark)
            results$model6.1.tsglm.newark.coef$site          <- 'Newark'
            results$model6.1.tsglm.newark.coef$indicator     <- indicator
            results$model6.1.tsglm.newark.coef$sub.indicator <- sub.indicator
        }
        ##################################################
        ## Model 6.1 - Rochdale                           ##
        ##################################################
        ...
        regressors <- dplyr::filter(df6.1,
                      ...
                      dplyr::select(closure, season2, season3, season4, season5, season6, relative.month, nhs111, other.centre, ambulance.divert)
        if(town.group$n[town.group$town == 'Rochdale'] > 0){
            model6.1.tsglm.rochdale <- tsglm(ts = ts.vector,
                                           link = tsglm.link,
                                           model = tsglm.model,
                                           xreg  = regressors,
                                           distr = tsglm.distr)
            results$model6.1.tsglm.rochdale.coef <- se(model6.1.tsglm.rochdale)
            results$model6.1.tsglm.rochdale.coef$site          <- 'Rochdale'
            results$model6.1.tsglm.rochdale.coef$indicator     <- indicator
            results$model6.1.tsglm.rochdale.coef$sub.indicator <- sub.indicator
        }
        ## Summary table
        results$model6.1.tsglm.coefficients <- combine_coefficients(bishop.coef     = results$model6.1.tsglm.bishop.coef,
                                                                  hartlepool.coef = results$model6.1.tsglm.hartlepool.coef,
                                                                  hemel.coef      = results$model6.1.tsglm.hemel.coef,
                                                                  newark.coef     = results$model6.1.tsglm.newark.coef,
        ...
        ## Return model objects if requested
        if(return.model == TRUE){
            if(exists('model6.1.tsglm.bishop')){
                results$model6.1.tsglm.bishop     <- model6.1.tsglm.bishop
            }
            if(exists('model6.1.tsglm.hartlepool')){
                results$model6.1.tsglm.hartlepool <- model6.1.tsglm.hartlepool
            }
            if(exists('model6.1.tsglm.hemel')){
                results$model6.1.tsglm.hemel      <- model6.1.tsglm.hemel
            }
            if(exists('model6.1.tsglm.newark')){
                results$model6.1.tsglm.newark     <- model6.1.tsglm.newark
            }
            if(exists('model6.1.tsglm.rochdale')){
                results$model6.1.tsglm.rochdale   <- model6.1.tsglm.rochdale
            }
        }
        if(return.df == TRUE){
        ...
        if(return.residuals == TRUE){
            if(exists('model6.1.tsglm.bishop')){
                results$model6.1.tsglm.residuals.bishop     <- summary(model6.1.tsglm.bishop)$residuals
            }
            if(exists('model6.1.tsglm.hartlepool')){
                results$model6.1.tsglm.residuals.hartlepool <- summary(model6.1.tsglm.hartlepool)$residuals
            }
            if(exists('model6.1.tsglm.hemel')){
                results$model6.1.tsglm.residuals.hemel      <- summary(model6.1.tsglm.hemel)$residuals
            }
            if(exists('model6.1.tsglm.newark')){
                results$model6.1.tsglm.residuals.newark     <- summary(model6.1.tsglm.newark)$residuals
            }
            if(exists('model6.1.tsglm.rochdale')){
                results$model6.1.tsglm.residuals.rochdale   <- summary(model6.1.tsglm.rochdale)$residuals
            }
        }
        ## Remove clutter
        rm(df6.1)
    ...
    results$model0.tsglm.coefficients$model   <- 'Model 0'
    results$model1.tsglm.coefficients$model   <- 'Model 1'
    results$model2.tsglm.coefficients$model   <- 'Model 2'
    results$model3.1.tsglm.coefficients$model <- 'Model 3.1'
    results$model3.2.tsglm.coefficients$model <- 'Model 3.2'
    results$model4.tsglm.coefficients$model   <- 'Model 4'
    results$model5.tsglm.coefficients$model   <- 'Model 5'
    results$model6.1.tsglm.coefficients$model <- 'Model 6.1'
    results$model6.2.tsglm.coefficients$model <- 'Model 6.2'
    ...
    model4.tsglm.coefficients <- dplyr::filter(results$model4.tsglm.coefficients, site != 'All')
    model5.tsglm.coefficients <- dplyr::filter(results$model5.tsglm.coefficients, site != 'All')
    model7.tsglm.coefficients <- dplyr::filter(results$model7.tsglm.coefficients, site != 'All')
    ...
    if(length(results$model1.coefficients) == 1) results$model1.tsglm.coefficients     <- NULL
    if(length(results$model2.coefficients) == 1) results$model2.tsglm.coefficients     <- NULL
    if(length(results$model3.1.coefficients) == 1) results$model3.1.tsglm.coefficients <- NULL
    if(length(results$model3.2.coefficients) == 1) results$model3.2.tsglm.coefficients <- NULL
    if(length(results$model4.coefficients) == 1) model4.tsglm.coefficients             <- NULL
    if(length(results$model5.coefficients) == 1) model5.tsglm.coefficients             <- NULL
    if(length(results$model6.1.coefficients) == 1) results$model6.1.tsglm.coefficients <- NULL
    if(length(results$model6.2.coefficients) == 1) results$model6.2.tsglm.coefficients <- NULL
    if(length(results$model7.coefficients) == 1) model7.tsglm.coefficients             <- NULL
    ## Return all coefficients across models
    results$all.model.all.coef <- rbind(results$model1.tsglm.coefficients,
                                        results$model2.tsglm.coefficients,
                                        results$model3.1.tsglm.coefficients,
                                        results$model3.2.tsglm.coefficients,
                                        model4.tsglm.coefficients,
                                        model5.tsglm.coefficients,
                                        results$model6.1.tsglm.coefficients,
                                        results$model6.2.tsglm.coefficients,
                                        model7.tsglm.coefficients) %>%
                                  as.data.frame()
